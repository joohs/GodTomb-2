...
//    int space_x                     = (size.width - ICON_SIZE * 4) / 5;
    ...
    UILabel* item1 = [[UILabel alloc] initWithFrame:CGRectMake(0, ICON_SIZE+3, width, 12)];
    [item1 setText:@"目录"];
    ...
    _progress                       = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_catalog.frame), space_y, CDScreenWidth/4, ICON_SIZE)];
    [_progress setImage:[UIImage imageNamed:@"icon_item_progress"] forState:UIControlStateNormal];
    UILabel* item2 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_catalog.frame), ICON_SIZE+3, width, 12)];
    [item2 setText:@"进度"];
    ...
    _nightMode                   = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_progress.frame), space_y, CDScreenWidth/4, ICON_SIZE)];
    [_nightMode setImage:[UIImage imageNamed:@"icon_item_bright"] forState:UIControlStateNormal];
    UILabel* item3 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_progress.frame), ICON_SIZE+3, width, 12)];
    [item3 setText:@"日·夜间"];
    ...
    _settings                       = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_nightMode.frame), space_y, CDScreenWidth/4, ICON_SIZE)];
    [_settings setImage:[UIImage imageNamed:@"more"] forState:UIControlStateNormal];
    UILabel* item4 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_nightMode.frame), ICON_SIZE+3, width, 12)];
    [item4 setText:@"更多"];
